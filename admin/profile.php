    ...
    public function updateProfile() {
        if (strlen($_SESSION['aid']) == 0) {
            ...
            if (isset($_POST['update'])) {
                ...
                $query = mysqli_query($this->con, "update tbladmin set AdminName='$fname',MobileNumber='$mobileno',Email='$email' where  ID='$adminid'");
                if ($query) {
...
$adminProfileUpdate = new AdminProfileUpdate($con);
$adminProfileUpdate->updateProfile();
?>
