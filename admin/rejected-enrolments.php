...
class RejectedEnrollmentsManager {
    private $con;
    ...
    public function getRejectedEnrollments() {
        $query = mysqli_query($this->con, "SELECT * FROM tblenrollment WHERE enrollStatus = 'Rejected'");
        return $query;
    }
}
...
if(strlen($_SESSION['aid']) == 0) {
    ...
    $rejectedEnrollmentsManager = new RejectedEnrollmentsManager($con);
?>
<!DOCTYPE html>
<html lang="en">
<head>
