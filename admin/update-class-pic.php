...
class UpdateClassPic {
    ...
    public function updateClassPicture() {
        if (strlen($_SESSION['aid']) == 0) {
            ...
            if (isset($_POST['submit'])) {
                ...
                if (!in_array($extension, $allowed_extensions)) {
                    ...
                    $query = mysqli_query($this->con, "update tblclasses set feacturePic='$newprofilepic' where id='$cid'");
                    if ($query) {
...
$updateClassPic = new UpdateClassPic($con);
$updateClassPic->updateClassPicture();
?>
