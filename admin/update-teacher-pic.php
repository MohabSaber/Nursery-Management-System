...
class UpdateTeacherPic {
    ...
    public function updateTeacherPicture() {
        if (strlen($_SESSION['aid']) == 0) {
            ...
            if (isset($_POST['submit'])) {
                ...
                if (!in_array($extension, $allowed_extensions)) {
                    ...
                    $query = mysqli_query($this->con, "update tblteachers set teacherPic='$newprofilepic' where id='$lid'");
                    if ($query) {
...
$updateTeacherPic = new UpdateTeacherPic($con);
$updateTeacherPic->updateTeacherPicture();
?>
