...
class EnrollmentManager {
    ...
    public function getNewEnrollments() {
        $query = mysqli_query($this->con, "SELECT * FROM tblenrollment WHERE (enrollStatus IS NULL OR enrollStatus = '')");
        return $query;
    }
}
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<<<<<<< HEAD
<?php   $newEnrollments = $enrollmentManager->getNewEnrollments();
  $cnt = 1;
  while ($result = mysqli_fetch_array($newEnrollments)) {
?>
